export const SiteTop = () => {
  return (
    <div>
      <div
        style={{ backgroundImage: "url(img/main_bg.jpg)" }}
      ...
      <div className="w-screen h-screen relative flex flex-col items-center justify-end pb-32">
        <div className="xs:text-xs sm:text-sm md:text-md  text-white font-serif mb-10 tracking-widest font-extralight">
          SOGA FARM SPECIALITY
        </div>
        ...
        <div className="xs:text-xs sm:text-sm md:text-md lg:text-lg text-white font-serif tracking-widest font-extralight">
          トマトの甘みは冬が育てた
        </div>
      </div>
    </div>
