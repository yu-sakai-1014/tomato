  ...
  return (
    <div className="xs:flex lg:hidden justify-center w-screen bg-white">
      <div className="py-36 flex flex-col items-center">
        <div
          style={{ width: "400px", height: "600px", background: "#F2F0EC" }}
          className="min-w-0 w-full absolute"
        ></div>
        <div className="tracking-wide text-gray-500 text-xs w-40 transform -rotate-90 z-10 relative right-44 top-16">
          2021 NEW PRODUCT
        </div>
        <img
          width="350"
